...
const EN = new Map<string, string>([
  ...
  ["選擇使用模式", "Choose a mode"],
  ["正式系統", "Production system"],
  ["Demo 模式", "Demo mode"],
  [
    "連接正式 API 與實體機器人，建立的任務會進入真實佇列。",
    "Connects to the production API and physical robot. New requests enter the live queue.",
  ],
  [
    "使用瀏覽器本機模擬資料，不會控制實體機器人。",
    "Uses local browser simulation data and never controls the physical robot.",
  ],
  ["進入正式後台", "Open production admin"],
  ["進入正式顧客介面", "Open production customer app"],
  ["進入 Demo 後台", "Open demo admin"],
  ["進入 Demo 顧客介面", "Open demo customer app"],
  ["系統流程", "How it works"],
  ...
  ["確定取消等待中的訂單 #{{number}}？", "Cancel pending order #{{number}}?"],
  ["取消訂單", "Cancel order"],
  ["取消中...", "Cancelling..."],
  [
    "任務已開始或狀態已變更，無法取消。",
    "The task has started or changed state and can no longer be cancelled.",
  ],
  ["取消訂單失敗，請稍後再試。", "Unable to cancel the order. Please try again later."],
  ["等待中", "Waiting"],
  ["執行中", "In progress"],
  ...
  ["無法讀取機器人狀態。", "Unable to load robot status."],
  ["線上", "Online"],
  ["離線", "Offline"],
  ["模式", "Mode"],
  ["最後回報", "Last heartbeat"],
  ...
  ["已充滿", "Full"],
  [
    "機器人 heartbeat 已逾時，請檢查車端服務。",
    "Robot heartbeat timed out. Check the robot-side services.",
  ],
  ["目前沒有任務", "No tasks yet"],
  ["手動派發", "Dispatch"],
  ["標記完成", "Mark complete"],
